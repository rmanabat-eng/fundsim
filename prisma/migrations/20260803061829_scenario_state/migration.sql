...
INSERT INTO "new_Company" ("createdAt", "dealId", "exitDate", "exitValue", "id", "name", "quality", "sector") SELECT "createdAt", "dealId", "exitDate", "exitValue", "id", "name", "quality", "sector" FROM "Company";
DROP TABLE "Company";
