...
export function Term({ children, def }: { children: ReactNode; def: string }) {
  return (
    <span className="group/term relative inline-block hover:z-30 focus-within:z-30">
      <span
        tabIndex={0}
      ...
      <span
        aria-hidden="true"
        className="max-card-solid pointer-events-none invisible absolute -left-2 bottom-full z-20 mb-1.5 w-56 rounded-lg px-3 py-2 text-xs font-normal normal-case tracking-normal text-white/85 group-hover/term:visible group-focus-within/term:visible"
