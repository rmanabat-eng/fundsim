    ...
    <Shell year={game.year} market={game.market as Market}>
      <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-3">
        <Stat
          icon="📅"
          label="Year"
          value={`${game.year} of ${GAME_YEARS}`}
          accent="from-sky-400 to-cyan-600"
          hint={`A venture fund runs on a clock: years 1–${INVESTMENT_PERIOD_YEARS} are the investment period (fresh pitches), years ${INVESTMENT_PERIOD_YEARS + 1}–${GAME_YEARS} are pure portfolio management. After year ${GAME_YEARS} the fund closes and you're graded.`}
        />
        <Stat
          icon="💰"
          label="Dry powder"
