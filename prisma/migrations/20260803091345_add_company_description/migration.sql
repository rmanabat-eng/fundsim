...
INSERT INTO "new_Company" ("createdAt", "dealId", "exitDate", "exitValue", "id", "name", "quality", "scenarioState", "sector") SELECT "createdAt", "dealId", "exitDate", "exitValue", "id", "name", "quality", "scenarioState", "sector" FROM "Company";
DROP TABLE "Company";
